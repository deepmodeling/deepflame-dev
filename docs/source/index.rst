...
platform to bring together the individual strengths of `OpenFOAM <https://openfoam.org/>`_, `Cantera <https://cantera.org/>`_ and `Torch <https://pytorch.org/libraries>`_ libraries
