...
#include "dfDiagonalPreconditioner.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(dfDiagonalPreconditioner, 0);

    dfMatrix::preconditioner::
        addsymMatrixConstructorToTable<dfDiagonalPreconditioner>
        adddiagonalPreconditionerSymMatrixConstructorToTable_;

    dfMatrix::preconditioner::
        addasymMatrixConstructorToTable<dfDiagonalPreconditioner>
...
Foam::dfDiagonalPreconditioner::dfDiagonalPreconditioner
(
...
void Foam::dfDiagonalPreconditioner::precondition
(
    scalarField& wA,
