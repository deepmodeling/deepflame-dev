...
#include "dfGAMGPreconditioner.H"
#include <mpi.h>
...
namespace Foam
{
    defineTypeNameAndDebug(dfGAMGPreconditioner, 0);

    dfMatrix::preconditioner::addsymMatrixConstructorToTable
    <dfGAMGPreconditioner> adddfGAMGPreconditionerSymMatrixConstructorToTable_;

    dfMatrix::preconditioner::addasymMatrixConstructorToTable
    <dfGAMGPreconditioner> adddfGAMGPreconditionerAsymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::dfGAMGPreconditioner::dfGAMGPreconditioner
(
...
void Foam::dfGAMGPreconditioner::readControls()
{
    dfGAMGSolver::readControls();
    nVcycles_ = controlDict_.lookupOrDefault<label>("nVcycles", 2);
}


void Foam::dfGAMGPreconditioner::precondition
(
    scalarField& wA,
