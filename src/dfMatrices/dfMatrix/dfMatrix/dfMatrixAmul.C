...
Foam::tmp<Foam::scalarField> Foam::dfMatrix::residual
(
    const scalarField& psi,
    const scalarField& source,
    const FieldField<Field, scalar>& interfaceBouCoeffs,
...
// Foam::tmp<Foam::scalarField > Foam::dfMatrix::H1() const
// {
//     tmp<scalarField > tH1
//     (
