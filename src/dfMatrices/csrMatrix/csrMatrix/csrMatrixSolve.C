...
template<class Type>
SolverPerformance<Type> csrMatrix::solve(
    ...
    for (direction cmpt=0; cmpt<Type::nComponents; cmpt++)
    {
        ...
        // Solver call
        solverPerf = csrMatrix::solver::New
        (
...
template<>
solverPerformance csrMatrix::solve
(
...
template<class Type>
void csrMatrix::addBoundarySource
(
    Field<Type>& source,
...
template<class Type>
void csrMatrix::addBoundaryDiag
(
    scalarField& diag,
    const FieldField<Field, Type>& internalCoeffs,
...
void csrMatrix::addToInternalField
(
...
template
void csrMatrix::addToInternalField<scalar>
(
    const labelUList& addr,
...
template
void csrMatrix::addToInternalField<vector>
(
    const labelUList& addr,
...
template
void csrMatrix::addBoundarySource<scalar>
(
    Field<scalar>& source,
...
template
void csrMatrix::addBoundarySource<vector>
(
    Field<vector>& source,
...
template
void csrMatrix::addBoundaryDiag<scalar>
(
    scalarField& diag,
    const FieldField<Field, scalar>& internalCoeffs,
    const direction solveCmpt
...
template
void csrMatrix::addBoundaryDiag<vector>
(
    scalarField& diag,
